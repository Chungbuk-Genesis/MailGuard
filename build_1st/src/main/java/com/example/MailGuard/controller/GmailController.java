...
public class GmailController {
    ...
    private final GmailOAuthService gmailOAuthService;  // ✅ 소문자로 수정
    ...
    public GmailController(
            ...
            GmailOAuthService gmailOAuthService,  // ✅ 소문자로 수정
            VirusTotalService virusTotalService,
            @Value("${google.redirect-uri}") String redirectUri) {
        this.flow = flow;
        this.gmailService = gmailService;
        this.gmailOAuthService = gmailOAuthService;  // ✅ 소문자로 수정
    ...
    public ResponseEntity<?> fetchGmailDemo(HttpSession session) {
        ...
        try {
            ...
            // ✅ 소문자 변수명 사용
            List<EmailDto> emails = gmailOAuthService.fetchAndAnalyzeEmails(credential, 3);
