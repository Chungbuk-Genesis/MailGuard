...
public class AttachmentDto {
    ...
    public AttachmentDto(String filename, String messageId, String attachmentId) {
        ...
        // [수정됨] 컨트롤러 경로(@RequestMapping("/api/gmail"))에 맞춰 URL 수정
        // 경로는 "/api/gmail/attachment/download" 가 되어야 합니다.
        this.downloadUrl = String.format("/api/gmail/attachment/download?msgId=%s&attId=%s&filename=%s",
                messageId,
                attachmentId,
