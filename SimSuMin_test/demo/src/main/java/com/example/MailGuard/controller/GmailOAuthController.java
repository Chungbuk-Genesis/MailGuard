...
//@CrossOrigin(origins = "*")  // ✨ CORS 전역 설정 추가
...
//    public ResponseEntity<?> fetchGmailDemo() {
//        try {
//            log.info("🚀 Gmail 메일 가져오기 시작 (Demo - 3개)");
//
//            // 최근 3개 메일만 가져오기
//            List<EmailDto> emails = gmailOAuthService.fetchAndAnalyzeEmails(10);
//
...
//
//            log.info("✅ Gmail 메일 {}개 분석 완료 (위험: {}, 의심: {}, 안전: {})",
//                    emails.size(), dangerousCount, suspiciousCount, safeCount);
//
...
//            errorResponse.put("error", "Gmail 연동 실패: " + e.getMessage());
//
